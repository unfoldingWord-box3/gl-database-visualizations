...
result_layer_fields = [
    ...
    QgsField('nearest_distances', QVariant.String),
    QgsField('nearest_vertices', QVariant.String),
]
...
for point_feature in repoints_layer.getFeatures():
    ...
    for polygon_id in polygon_ids:
        ...
        if polygon_feature and polygon_feature.geometry().contains(point_geometry):
            ...
            nearest_vertices.append(f"{nearest_vertex.x()},{nearest_vertex.y()}")
    ...
    result_feature.setAttributes([
        ...
        ','.join(farthest_vertices),
        ','.join(map(str, nearest_distances)),
        ','.join(nearest_vertices)
    ])
